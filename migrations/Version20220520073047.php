 ...
 */
final class Version20220520073047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP lieu_id, DROP site_organisateur_id, DROP organisateur_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD site_organisateur_id INT NOT NULL, ADD organisateur_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE ville ADD lieux_id INT NOT NULL');
